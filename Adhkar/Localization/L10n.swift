...
enum L10n {
    ...
    static let contactTitle = LocalizedText(ar: "تواصل معنا", fr: "Nous contacter", en: "Contact us")
    static let contactSection = LocalizedText(ar: "كيف نساعدك؟", fr: "Comment t’aider ?", en: "How can we help?")
    static let contactReasonLabel = LocalizedText(ar: "الموضوع", fr: "Sujet", en: "Topic")
    static let contactReasonBug = LocalizedText(ar: "الإبلاغ عن مشكلة", fr: "Signaler un problème", en: "Report a problem")
    static let contactReasonContent = LocalizedText(ar: "تصحيح نص أو مصدر", fr: "Corriger un texte ou une source", en: "Correct text or source")
    static let contactReasonSuggestion = LocalizedText(ar: "اقتراح", fr: "Suggestion", en: "Suggestion")
    static let contactReasonQuestion = LocalizedText(ar: "سؤال", fr: "Question", en: "Question")
    static let contactMessagePlaceholder = LocalizedText(ar: "اكتب رسالتك…", fr: "Écris ton message…", en: "Write your message…")
    static let contactFeelingLabel = LocalizedText(ar: "كيف تشعر؟", fr: "Comment te sens-tu ?", en: "How do you feel?")
    static let contactFeelingMail = LocalizedText(ar: "Ressenti dans l’application :", fr: "Ressenti dans l’application :", en: "Feeling in the app:")
    static let contactSend = LocalizedText(ar: "إرسال", fr: "Envoyer", en: "Send")
    static let contactLimit = LocalizedText(ar: "ثلاث رسائل كحد أقصى يوميًا.", fr: "Trois messages maximum par jour.", en: "Three messages maximum per day.")
    static let contactLimitTitle = LocalizedText(ar: "الحد اليومي بلغ أقصاه", fr: "Limite quotidienne atteinte", en: "Daily limit reached")
    static let contactLimitMessage = LocalizedText(ar: "يمكنك إرسال ثلاث رسائل فقط يوميًا. حاول غدًا.", fr: "Tu peux envoyer trois messages par jour. Réessaie demain.", en: "You can send three messages per day. Try again tomorrow.")
    static let contactUnavailableTitle = LocalizedText(ar: "البريد غير متاح", fr: "Mail indisponible", en: "Mail unavailable")
    static let contactUnavailableMessage = LocalizedText(ar: "أضف حساب بريد إلى جهازك ثم حاول مجددًا.", fr: "Ajoute un compte Mail sur ton appareil puis réessaie.", en: "Add a Mail account to your device and try again.")
